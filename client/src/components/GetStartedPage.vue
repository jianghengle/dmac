  ...
  <div class="get-started-page">
    ...
    <div class="content get-started-content">
      ...
      <div>
        ...
        <ol>
          <li>
            Open your web browser and navigate to <a href="https://dmac.unl.edu">https://dmac.unl.edu</a>, and then click the <span class="quote">Globus login</span> as showed in the screenshot below.
            <span class="screenshot"><img src="static/get_started/login1.png"></img></span>
          </li>
          <li>
            Then your browser will redirect to the Globus Login page, where you should pick your university from the dropdown menu and then click <em>Continue</em>.
            <span class="screenshot"><img src="static/get_started/login2.png"></img></span>
          </li>
          <li>
            Now your browser should redirect to your school Login page, where you should login your univeristy account.
        ...
        <p>Please note that if this is the first time you login DMAC through Globus, the system actually just created a new DMAC account for you according to your unversity's email address.</p>
        ...
        <p>
          ...
          If you created your account by logining through Globus, you could set your DMAC account password by clicking <span class="quote">Forgot your password?</span>.
          If you do not have a DMAC account yet, instead of logining through Globus, you could also create an new account by clicking <span class="quote">Register new account</span>.
      ...
      <div>
        ...
        <p>
          To create a new project you could simply click <span class="quote">+ New Project</span> button on the projects page. (Only the DMAC <em>Project Managers</em> could create a new project. If you do not see the <span class="quote">+ New Project</span> button, you are a normal user without creating projects permission. Though, you could contact <a href="mailto:jianghengle@gmail.com">jianghengle@gmail.com</a> to request one.) After clicking the button, it should pop up a the new project form as shown below.
          <span class="screenshot"><img src="static/get_started/project1.png"></img></span>
          Except for filling the <em>Name</em> and <em>Description</em> fields, you could also click the <em>Template</em> dropdown to select a template, where you might also need to fill out some metadata to create your new project.
        </p>
        ...
        <p>
          A project can only be accessed by its users. These users are shown in the <em>Users</em> tab inside the project. Each user is identified by its email address of its DMAC account, and each user has a particular role which specify how the user could access the project and work on the data.
          <ul>
            <li><em>Owner</em> is the user who created the project, which has full permission on the project, project users and project data inside.</li>
            <li><em>Admin</em>s also have full permission on the project and its data inside, except deleting the project and add/remove other project <em>Admin</em>s.</li>
      ...
      <div>
        ...
        <p>For files bigger than 2TB or folders which are not able to be uploaded directly through web browser, you should utilize Globus to accomplish the transfer task. The endpoint of the DMAC system on Globus is <em>hcc#dmac</em>. In the Globus UI as shown below, you need to specify the endpoint or collection, and fill in your DMAC username and password. After authorized by the DMAC server, you should  be able to see your projects and transfer data from/to the DMAC server.<span class="screenshot"><img src="static/get_started/transfer3.png"></img></span></p>

        <h4 id="transferToFromCyverse">Transfer to/from CyVerse</h4>
        <p>You could also transfer data between DMAC and CyVerse. At any folder view, you can find the <em>CyVerse</em> in the <em>Actions</em> menu. After clicking <em>CyVerse</em>, a modal will pop up where you could login CyVerse and transfer your data.<span class="screenshot"><img src="static/get_started/transfer4.png"></img></span></p>
      </div>
      ...
      <div>
        ...
        <p>The project data explorer UI looks very similar to a Window File Explorer in web browser, where you can navigate by the sidebar or click on the folder or file directly. You could preview almost any type of files in the browser from plain text to Excel document. And you could even manipulate the data online directly, for example create/update/delete/copy folders and files.
